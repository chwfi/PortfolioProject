...
public class Task : ScriptableObject
{
    ...
    [Header("Setting")]
    [SerializeField]
    private InitialSuccessValue _initialSuccessValue; //초기 성공값
    [SerializeField]
    private int _needSuccessToComplete; //성공까지 필요한 횟수
    [SerializeField]
    private bool _canRecevieReportDuringCompletion; //성공한 후에도 계속 성공값을 받을것이냐
